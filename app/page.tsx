...
const EXEC_QUESTIONS = [
  'How do we make our enterprise data truly AI-ready?',
  'How do we trust the data, decisions and recommendations generated by AI?',
  'How do we move Generative AI and Agentic AI from pilot to production?',
  'How do we scale enterprise AI securely, responsibly and with governance?',
  'How do we measure AI through business outcomes — not models, pilots or activity?',
];
      ...
      <Section dark>
        <Wrap>
          <SectionHead
            ...
            lede="The challenge is turning data into trusted decisions, intelligent actions and measurable business outcomes."
          />
