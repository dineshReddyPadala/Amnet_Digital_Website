...
export function Header() {
  ...
  const linkClass = (href: string) =>
    `flex items-center gap-1.5 py-2.5 px-3.5 tablet:px-2.5 text-[14.5px] font-medium rounded-[10px] transition-colors hover:text-ink hover:bg-black/5 whitespace-nowrap ${
  ...
  return (
    <header className="sticky top-0 z-[200] bg-[#FAFAFD]/85 backdrop-blur-[16px] border-b border-line">
      <nav className="flex items-center gap-[34px] tablet:gap-3 h-[74px] max-w-wrap mx-auto px-7" aria-label="Main">
        ...
        <ul className="flex mobile:hidden gap-1 tablet:gap-0 ml-auto items-center flex-none">
          ...
          <li className="list-none ml-2 flex-none">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2.5 rounded-full font-semibold font-display py-2.5 px-5 tablet:px-3.5 text-sm bg-molten text-white shadow-[0_12px_30px_-10px_rgba(86,70,229,0.5)] hover:-translate-y-0.5 transition-transform whitespace-nowrap"
            >
              Talk to an Expert
            </Link>
          </li>
        ...
        <button
          className="hidden mobile:grid place-items-center ml-auto w-11 h-11 text-ink"
