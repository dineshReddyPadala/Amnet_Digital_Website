...
export function QuoteBlock({ quote, initials, name, role }: QuoteBlockProps) {
  return (
    <Reveal
      ...
      as="div"
    >
      <p className="text-[clamp(17px,1.6vw,20px)] text-[#CBD5E4] max-w-[70ch] relative">{quote}</p>
      <div className="mt-[26px] flex items-center gap-3.5">
        <span className="w-[52px] h-[52px] rounded-full bg-molten grid place-items-center font-display font-extrabold text-white">
          {initials}
        </span>
        <span>
