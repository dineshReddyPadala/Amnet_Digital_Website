...
export function CtaBand({ heading, paragraph, children }: CtaBandProps) {
  return (
    <Reveal
    ...
    >
      ...
      />
      <div>
        <h2 className="text-[clamp(26px,3vw,38px)] max-w-[22ch] text-white">{heading}</h2>
        <p className="text-[#AAB7CB] mt-2.5 max-w-[52ch]">{paragraph}</p>
      </div>
